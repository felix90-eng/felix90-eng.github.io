 ...
 */
final class Version20200410165543 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tbl_expenses ADD status VARCHAR(255) DEFAULT NULL, CHANGE mission_id mission_id INT DEFAULT NULL, CHANGE staff_id staff_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tbl_allowances CHANGE level_id level_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE tbl_appusers CHANGE role_id role_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE tbl_expenses DROP status, CHANGE mission_id mission_id INT DEFAULT NULL, CHANGE staff_id staff_id INT DEFAULT NULL');
