 ...
 */
final class Version20200405152449 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tbl_vehicles ADD travelmode VARCHAR(255) DEFAULT NULL, ADD travellerquantity VARCHAR(255) DEFAULT NULL, CHANGE staff_id staff_id INT DEFAULT NULL, CHANGE position_id position_id INT DEFAULT NULL, CHANGE destination_id destination_id INT DEFAULT NULL, CHANGE purpose purpose VARCHAR(255) DEFAULT NULL, CHANGE transportername transportername VARCHAR(255) DEFAULT NULL, CHANGE companyname companyname VARCHAR(255) DEFAULT NULL, CHANGE platno platno VARCHAR(255) DEFAULT NULL, CHANGE telephone telephone VARCHAR(255) DEFAULT NULL, CHANGE tripamount tripamount VARCHAR(255) DEFAULT NULL, CHANGE tripdays tripdays VARCHAR(255) DEFAULT NULL, CHANGE totalamount totalamount VARCHAR(255) DEFAULT NULL, CHANGE ttelephone ttelephone VARCHAR(255) DEFAULT NULL, CHANGE transporterstyle transporterstyle VARCHAR(255) DEFAULT NULL');
